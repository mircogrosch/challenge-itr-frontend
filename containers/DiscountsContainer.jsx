...
export default function DiscountsContainer({benefits}) { 
    return(
        ...
        <h1>Códigos de descuento</h1>
         <p>¿Sos socio de Club LA NACION? Descargá tu código y disfrutá beneficios exclusivos en tus marcas favoritas</p>
        <div> 
        ...
        <Carousel show={"four"}> 
              {benefits.map((benefit)=>{ 
                return(
                  ...
                  <div style={{padding:8}}>
                  <DiscountsCard name={benefit.name} image={benefit.images[0].url}/>
                  </div>
                  </div>
                )
              })}
